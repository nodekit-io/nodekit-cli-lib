...
#ifndef NODEKIT_H_DJJKASDM44
#define NODEKIT_H_DJJKASDM44

#include <QtCore>
#include <cassert>

#include "cplugin.h"
#include "nodekit_config.hpp"
...
public:
    explicit NodeKit(const QDir &wwwDir, QQuickItem *item, QObject *parent = nullptr);
    ...
    const NodeKitInternal::Config& config() const;
...
private:
    ...
    NodeKitInternal::Config _config;

    Q_DISABLE_COPY(NodeKit)
};
