 ...
 *   string is ready to be written to 'nodekit_plugins.js'
 *
 * @returns {String} nodekit_plugins.js contents
 */
PlatformJson.prototype.generateMetadata = function () {
    return [
        'nodekit.define(\'nodekit/plugin_list\', function(require, exports, module) {',
        'module.exports = ' + JSON.stringify(this.root.modules, null, 4) + ';',
        'module.exports.metadata = ',
        '// TOP OF METADATA',
        JSON.stringify(this.root.plugin_metadata, null, 4) + ';',
        '// BOTTOM OF METADATA',
        '});' // Close nodekit.define.
    ].join('\n');
};
 ...
 *
 * Creates a ModuleMetadata object that represents module entry in 'nodekit_plugins.js'
 *   file at run time
 *
