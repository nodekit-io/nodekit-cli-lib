...
var path = require('path'),
    ...
    NodeKitLogger = require('../NodeKitLogger');
...
function munge_helper(should_increment, self, platform_config, config_munge) {
    ...
    // TODO: The should_increment param is only used by nodekit-cli and is going away soon.
...
// Used by nodekit prepare to re-generate some config file from platform
