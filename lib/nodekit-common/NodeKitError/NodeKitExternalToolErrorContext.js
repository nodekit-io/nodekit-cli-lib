 ...
 * @constructor
 */
function NodeKitExternalToolErrorContext(cmd, args, cwd) {
    this.cmd = cmd;
...
NodeKitExternalToolErrorContext.prototype.toString = function(isVerbose) {
    if(isVerbose) {
...
module.exports = NodeKitExternalToolErrorContext;
