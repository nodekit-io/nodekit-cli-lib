...
/**
 The complete user agent that NodeKit will use when sending web requests.
 */
@property (nonatomic, readonly) NSString* userAgent;

/**
 The base user agent data that NodeKit will use to build its user agent.  If this
 property isn't set, NodeKit will use the standard web view user agent as its
 base.
 */
