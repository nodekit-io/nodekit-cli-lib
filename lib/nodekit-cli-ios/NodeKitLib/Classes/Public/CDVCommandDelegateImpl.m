...
- (void)sendPluginResult:(CDVPluginResult*)result callbackId:(NSString*)callbackId
{
    ...
    NSString* js = [NSString stringWithFormat:@"nodekit.require('nodekit/exec').nativeCallback('%@',%d,%@,%d, %d)", callbackId, status, argumentsAsJSON, keepCallback, debug];
...
{
    js = [NSString stringWithFormat:@"try{nodekit.require('nodekit/exec').nativeEvalAndFetch(function(){%@})}catch(e){console.log('exception nativeEvalAndFetch : '+e);};", js];
