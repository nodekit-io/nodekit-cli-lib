...
static NSString* const kCdvUserAgentKey = @"NodeKit-User-Agent";
static NSString* const kCdvUserAgentVersionKey = @"NodeKit-User-Agent-Version";
...
+ (NSString*)originalUserAgent
{
    if (gOriginalUserAgent == nil) {
        ...
        NSString* nodekitUserAgentVersion = [userDefaults stringForKey:kCdvUserAgentVersionKey];
        gOriginalUserAgent = [userDefaults stringForKey:kCdvUserAgentKey];
        BOOL cachedValueIsOld = ![systemAndLocale isEqualToString:nodekitUserAgentVersion];
