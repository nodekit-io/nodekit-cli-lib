...
{
    NSString* loadToken = [webView stringByEvaluatingJavaScriptFromString:@"window.__nodekitLoadToken"];
...
{
    _curLoadToken += 1;
    [webView stringByEvaluatingJavaScriptFromString:[NSString stringWithFormat:@"window.__nodekitLoadToken=%ld", (long)_curLoadToken]];
}
