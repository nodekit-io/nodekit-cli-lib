...
module.exports.prepare = function (nodekitProject) {
    ...
    .then(function () {
        handleIcons(nodekitProject.projectConfig, self.locations.xcodeNodeKitProj);
    })
    .then(function () {
...
function updateWww(nodekitProject, destinations) {
    ...
    shell.cp('-rf', path.join(nodekitProject.locations.www, '*'), destinations.www);
...
function updateProject(platformConfig, locations) {
    ...
    return handleBuildSettings(platformConfig, locations).then(function() {
        ...
        try {
            ...
            return Q.reject(new NodeKitError('An error occurred during parsing of project.pbxproj. Start weeping. Output: ' + err));
        }
