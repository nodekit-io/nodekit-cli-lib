...
- (void) sendPluginResult:(CDVPluginResult*) result callbackId:(NSString*) callbackId {
    ...
    NSString* js = [NSString stringWithFormat:@"nodekit.require('nodekit/exec').nativeCallback('%@',%d,%@,%d)", callbackId, status, argumentsAsJSON, keepCallback];
...
- (void) evalJs:(NSString*) js scheduledOnRunLoop:(BOOL) scheduledOnRunLoop {
    js = [NSString stringWithFormat:@"nodekit.require('nodekit/exec').nativeEvalAndFetch(function(){%@})", js];
