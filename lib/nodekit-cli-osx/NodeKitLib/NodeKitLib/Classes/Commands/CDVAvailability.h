 ...
 */
    ...
    #define NODEKIT_VERSION_MIN_REQUIRED __NODEKIT_4_0_0
#endif
...
#ifdef __clang__
    #define CDV_DEPRECATED(version, msg) __attribute__((deprecated("Deprecated in NodeKit " #version ". " msg)))
#else
