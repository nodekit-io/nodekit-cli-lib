...
- (void) webView:(WebView*) webView didClearWindowObject:(WebScriptObject*) windowScriptObject forFrame:(WebFrame*) frame {
    ...
    [windowScriptObject setValue:self.bridge forKey:CDV_JS_KEY_NODEKITBRIDGE];
}
...
- (void) webView:(WebView*) sender didFinishLoadForFrame:(WebFrame*) frame {
    ...
    NSString* nativeReady = @"try{nodekit.require('nodekit/channel').onNativeReady.fire();}catch(e){window._nativeReady = true;}";
