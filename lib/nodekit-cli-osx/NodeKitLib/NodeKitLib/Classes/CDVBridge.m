...
- (void) registerJavaScriptHelpers {
    NSString* nodekitBridgeUtil = @"var NodeKitBridgeUtil = {};";
    NSString* dictionaryKeys = [NSString stringWithFormat:@"NodeKitBridgeUtil.getDictionaryKeys = function(obj) { return Object.keys(obj);};"];

    id win = [self.webView windowScriptObject];
    [win evaluateWebScript:nodekitBridgeUtil];
