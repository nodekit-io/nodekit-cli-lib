...
GradleBuilder.prototype.prepBuildFiles = function() {
    ...
    var pluginBuildGradle = path.join(this.root, 'nodekit', 'lib', 'plugin-build.gradle');
    ...
    var insertExclude = function(p) {
          ...
          if(projectGradleFile.indexOf('NodeKitLib') != -1) {
            depsList += '{\n        exclude module:("NodeKitLib")\n    }\n';
          }
          else {
            depsList +='\n';
          }
    ...
    propertiesObj.systemLibs.forEach(function(p) {
        ...
        if (/:.*:/.exec(p)) {
            ...
            if (!mavenRef) {
                throw new NodeKitError('Unsupported system library (does not work with gradle): ' + p);
            }
        }
...
GradleBuilder.prototype.prepEnv = function(opts) {
    ...
    .then(function() {
        ...
        /*jshint -W069 */
        var distributionUrl = process.env['NODEKIT_ANDROID_GRADLE_DISTRIBUTION_URL'] || 'http\\://services.gradle.org/distributions/gradle-2.14.1-all.zip';
        /*jshint +W069 */
