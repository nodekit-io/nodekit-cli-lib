...
module.exports.detectArchitecture = function(target) {
    ...
    return helper()
    .timeout(1000, new NodeKitError('Device communication timed out. Try unplugging & replugging the device.'))
            ...
            .then(function() {
                ...
                .then(null, function() {
                    ...
                    .then(function() {
                        return helper()
                        .then(null, function() {
                            return Q.reject(new NodeKitError('adb timed out a third time while detecting device/emulator architecture. Try unplugging & replugging the device.'));
                        });
                    });
                });
            }, function() {
