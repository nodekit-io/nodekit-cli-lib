...
module.exports.get_available_port = function () {
    ...
    .then(function (emulators) {
        ...
        throw new NodeKitError('Could not find an available avd port');
    });
};
...
module.exports.start = function(emulator_ID, boot_timeout) {
    ...
    return Q().then(function() {
        ...
        .then(function(best) {
            ...
            return Q.reject(new NodeKitError('No emulator images (avds) found.\n' +
        ...
        if (!emulatorId)
            return Q.reject(new NodeKitError('Failed to start emulator'));
            ...
            function adbInstallWithOptions(target, apk, opts) {
                ...
                return Q.promise(function (resolve, reject) {
                    child_process.exec(command, opts, function(err, stdout, stderr) {
                        if (err) reject(new NodeKitError('Error executing "' + command + '": ' + stderr));
                        ...
                        // message to stdout, so we have to use RegExp matching to detect installation failure.
                            ...
                            reject(new NodeKitError('Failed to install apk to emulator: ' + stdout));
                        } else resolve(stdout);
                    });
                });
            }
