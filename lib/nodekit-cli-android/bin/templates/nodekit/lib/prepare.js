...
module.exports.prepare = function (nodekitProject, options) {
    ...
    .then(function () {
        updateIcons(nodekitProject, path.relative(nodekitProject.root, self.locations.res));
        updateSplashes(nodekitProject, path.relative(nodekitProject.root, self.locations.res));
    })
    .then(function () {
...
function updateSplashes(nodekitProject, platformResourcesDir) {
    ...
    var resourceMap = mapImageResources(nodekitProject.root, platformResourcesDir, 'drawable', 'screen.png');
...
function updateIcons(nodekitProject, platformResourcesDir) {
    ...
    var resourceMap = mapImageResources(nodekitProject.root, platformResourcesDir, 'mipmap', 'icon.png');
