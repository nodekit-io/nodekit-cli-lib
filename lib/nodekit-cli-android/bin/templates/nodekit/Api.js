...
var selfEvents = require('nodekit-cli-lib')['nodekit-common'].events;
...
function setupEvents(externalEventEmitter) {
    ...
    NodeKitLogger.get().subscribe(selfEvents);
    return selfEvents;
}
...
function Api(platform, platformRootDir, events) {
    ...
    this.locations = {
        ...
        nodekitJs: 'bin/templates/project/assets/www/nodekit.js',
        nodekitJsSrc: 'cordova-js-src'
    };
}
