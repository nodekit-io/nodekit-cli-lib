...
var spawn = require('nodekit-cli-lib')['nodekit-common'].superspawn.spawn;
var NodeKitError = require('nodekit-cli-lib')['nodekit-common'].NodeKitError;

var ConfigParser, MSBuildTools, Version;
try {
    ConfigParser = require('../../template/nodekit/lib/ConfigParser');
    MSBuildTools = require('../../template/nodekit/lib/MSBuildTools');
    Version = require('../../template/nodekit/lib/Version');
} catch (ex) {
...
function getMinimalRequiredVersionFor (requirement, windowsTargetVersion, windowsPhoneTargetVersion) {
    ...
    if (windowsTargetVersion === '8' || windowsTargetVersion === '8.0') {
        throw new NodeKitError('windows8 platform is deprecated. To use windows-target-version=8.0 you may downgrade to nodekit-windows@4.');
    }

    if (windowsPhoneTargetVersion === '8' || windowsPhoneTargetVersion === '8.0') {
        throw new NodeKitError('8.0 is not a valid version for windows-phone-target-version (use the wp8 NodeKit platform instead)');
    }
...
var checkOS = function (windowsTargetVersion, windowsPhoneTargetVersion) {
    if (process.platform !== 'win32') {
        ...
        return Q.reject('NodeKit tooling for Windows requires Windows OS to build project');
    }
