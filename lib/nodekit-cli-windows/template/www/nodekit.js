...
// file: src/nodekit.js
define("nodekit", function(require, exports, module) {

// Workaround for Windows 10 in hosted environment case
// http://www.w3.org/html/wg/drafts/html/master/browsers.html#named-access-on-the-window-object
if (window.nodekit && !(window.nodekit instanceof HTMLElement)) {
    throw new Error("nodekit already defined");
}


var channel = require('nodekit/channel');
var platform = require('nodekit/platform');
...
var nodekit = {
    ...
    /**
     * Retrieve original event handlers that were replaced by NodeKit
     *
     * @return object
     */
    ...
    fireDocumentEvent: function(type, data, bNoDetach) {
        ...
        if (typeof documentEventHandlers[type] != 'undefined') {
            if( bNoDetach ) {
                ...
                setTimeout(function() {
                    // Fire deviceready on listeners that were registered before nodekit.js was loaded.
                    if (type == 'deviceready') {
    ...
    callbackSuccess: function(callbackId, args) {
        nodekit.callbackFromNative(callbackId, true, args.status, [args.message], args.keepCallback);
    },
    ...
    callbackError: function(callbackId, args) {
        ...
        nodekit.callbackFromNative(callbackId, false, args.status, [args.message], args.keepCallback);
    },
    ...
    callbackFromNative: function(callbackId, isSuccess, status, args, keepCallback) {
        try {
            var callback = nodekit.callbacks[callbackId];
            if (callback) {
                if (isSuccess && status == nodekit.callbackStatus.OK) {
                ...
                */
                ...
                if (!keepCallback) {
                    delete nodekit.callbacks[callbackId];
                }
            }
        }
        catch (err) {
            ...
            nodekit.fireWindowEvent("nodekitcallbackerror", { 'message': msg });
            throw err;
        }
    },
    addConstructor: function(func) {
        channel.onNodeKitReady.subscribe(function() {
            try {
                func();
            } catch(e) {
...
module.exports = nodekit;

});

// file: src/common/argscheck.js
define("nodekit/argscheck", function(require, exports, module) {

var utils = require('nodekit/utils');
...
define("nodekit/base64", function(require, exports, module) {
...
define("nodekit/builder", function(require, exports, module) {
...
function include(parent, objects, clobber, merge) {
    each(objects, function (obj, key) {
        try {
            ...
            utils.alert('Exception building NodeKit JS globals: ' + e + ' for key "' + key + '"');
        }
    });
}
...
define("nodekit/channel", function(require, exports, module) {
 ...
 * nodekit initialization, as well as for custom events thereafter.
 *
 * The order of events during page load and NodeKit startup is as follows:
 *
 * onDOMContentLoaded*         Internal event that is received when the web page is loaded and parsed.
 * onNativeReady*              Internal event that indicates the NodeKit native side is ready.
 * onNodeKitReady*             Internal event fired when all NodeKit JavaScript objects have been created.
 * onDeviceReady*              User event fired to indicate that NodeKit is ready
 ...
 *
 * The only NodeKit events that user code should register for are:
 *      deviceready           NodeKit native code is initialized and NodeKit APIs can be called from JavaScript
...
var Channel = function(type, sticky) {
    ...
    channel = {
        ...
        /**
         * nodekit Channels that must fire before "deviceready" is fired.
         */
         ...
         * This holds up NodeKit's "deviceready" event until the feature has been initialized
         * and NodeKit.initComplete(feature) is called.
         *
...
// Event to indicate the NodeKit native side is ready.
channel.createSticky('onNativeReady');

// Event to indicate that all NodeKit JavaScript objects have been created
// and it's time to run plugin constructors.
channel.createSticky('onNodeKitReady');

// Event to indicate that all automatically loaded JS plugins are loaded and ready.
// FIXME remove this
channel.createSticky('onPluginsReady');

// Event to indicate that NodeKit is ready
...
channel.waitForInitialization('onNodeKitReady');
...
// file: D:/nodekit/nodekit-windows/nodekit-js-src/confighelper.js
define("nodekit/confighelper", function(require, exports, module) {
...
function readConfig(success, error) {
    ...
    var xhrStatusChangeHandler = function () {
        if (xhr.readyState == 4) {
            if (xhr.status == 200 || xhr.status == 304 || xhr.status == 0 /* file:// */) {
                ...
                fail('[Windows][nodekit.js][xhrStatusChangeHandler] Could not XHR config.xml: ' + xhr.statusText);
            }
        }
    };
    ...
    try {
        ...
        fail('[Windows][nodekit.js][readConfig] Could not XHR config.xml: ' + JSON.stringify(e));
    }
}
...
// file: D:/nodekit/nodekit-windows/nodekit-js-src/exec.js
define("nodekit/exec", function(require, exports, module) {
...
define("nodekit/exec/proxy", function(require, exports, module) {
...
module.exports = {
    ...
    // example: nodekit.commandProxy.add("Accelerometer",{getCurrentAcceleration: function(successCallback, errorCallback, options) {...},...);
    ...
    // nodekit.commandProxy.remove("Accelerometer");
    remove:function(id) {
...
define("nodekit/init", function(require, exports, module) {

var channel = require('nodekit/channel');
var nodekit = require('nodekit');
var modulemapper = require('nodekit/modulemapper');
var platform = require('nodekit/platform');
var pluginloader = require('nodekit/pluginloader');
var utils = require('nodekit/utils');
...
function replaceNavigator(origNavigator) {
    var NodeKitNavigator = function() {};
    NodeKitNavigator.prototype = origNavigator;
    var newNavigator = new NodeKitNavigator();
    // This work-around really only applies to new APIs that are newer than Function.bind.
    // Without it, APIs such as getGamepads() break.
    if (NodeKitNavigator.bind) {
...
channel.onPause = nodekit.addDocumentEventHandler('pause');
channel.onResume = nodekit.addDocumentEventHandler('resume');
channel.onActivated = nodekit.addDocumentEventHandler('activated');
channel.onDeviceReady = nodekit.addStickyDocumentEventHandler('deviceready');
...
// it may be called before any nodekit JS is ready.
if (window._nativeReady) {
    channel.onNativeReady.fire();
}

modulemapper.clobbers('nodekit', 'nodekit');
modulemapper.clobbers('nodekit/exec', 'nodekit.exec');
modulemapper.clobbers('nodekit/exec', 'NodeKit.exec');

// Call the platform-specific initialization.
platform.bootstrap && platform.bootstrap();

// Wrap in a setTimeout to support the use-case of having plugin JS appended to nodekit.js.
...
/**
 * Create all nodekit objects once native side is ready.
 */
channel.join(function() {
    ...
    channel.onNodeKitReady.fire();

    // Fire onDeviceReady event once page has fully loaded, all
    // constructors have run and nodekit info has been received from native
    // side.
    channel.join(function() {
        require('nodekit').fireDocumentEvent('deviceready');
...
define("nodekit/init_b", function(require, exports, module) {
...
// setting exec
nodekit.exec = require('nodekit/exec');
...
define("nodekit/modulemapper", function(require, exports, module) {

var builder = require('nodekit/builder'),
...
define("nodekit/modulemapper_b", function(require, exports, module) {
...
// file: D:/nodekit/nodekit-windows/nodekit-js-src/platform.js
define("nodekit/platform", function(require, exports, module) {

module.exports = {
    id: 'windows',
    bootstrap:function() {
        var nodekit = require('nodekit'),
            exec = require('nodekit/exec'),
            channel = nodekit.require('nodekit/channel'),
            platform = require('nodekit/platform'),
            modulemapper = require('nodekit/modulemapper'),
            configHelper = require('nodekit/confighelper'),
            utils = require('nodekit/utils');

        modulemapper.clobbers('nodekit/exec/proxy', 'nodekit.commandProxy');
        ...
        var onWinJSReady = function () {
            var app = WinJS.Application,
                splashscreen = require('nodekit/splashscreen');

            modulemapper.clobbers('nodekit/splashscreen', 'navigator.splashscreen');

            var checkpointHandler = function checkpointHandler() {
                nodekit.fireDocumentEvent('pause',null,true);
            };

            var resumingHandler = function resumingHandler() {
                nodekit.fireDocumentEvent('resume',null,true);
            };

            // activation args are available via the activated event
            // OR nodekit.require('nodekit/platform').activationContext
            ...
            var activationHandler = function (e) {
                ...
                if (e.detail.previousExecutionState === Windows.ApplicationModel.Activation.ApplicationExecutionState.running
                    ...
                    nodekit.fireDocumentEvent('activated', platform.activationContext, true);
                    return;
                }
...
function injectBackButtonHandler() {
    ...
    var backButtonChannel = nodekit.addDocumentEventHandler('backbutton');
    ...
    var backRequestedHandler = function backRequestedHandler(evt) {
        ...
        if (backButtonChannel.numHandlers >= 1) {
            try {
                nodekit.fireDocumentEvent('backbutton', evt, true);
...
define("nodekit/pluginloader", function(require, exports, module) {

var modulemapper = require('nodekit/modulemapper');
var urlutil = require('nodekit/urlutil');
...
// Handler for the nodekit_plugins.js content.
...
exports.load = function(callback) {
    var pathPrefix = findNodeKitPath();
    if (pathPrefix === null) {
        console.log('Could not find nodekit.js script tag. Plugin loading may fail.');
        pathPrefix = '';
    }
    injectIfNecessary('nodekit/plugin_list', pathPrefix + 'nodekit_plugins.js', function() {
        var moduleList = require("nodekit/plugin_list");
...
define("nodekit/pluginloader_b", function(require, exports, module) {
...
// file: D:/nodekit/nodekit-windows/nodekit-js-src/splashscreen.js
define("nodekit/splashscreen", function(require, exports, module) {

var isPhone = (nodekit.platformId == 'windows') && WinJS.Utilities.isPhone;
...
define("nodekit/urlutil", function(require, exports, module) {
...
define("nodekit/utils", function(require, exports, module) {
...
window.nodekit = require('nodekit');
// file: src/scripts/bootstrap.js

require('nodekit/init');
