...
module.exports.getPackageFileInfo = function (packageFile) {
    ...
    // NodeKitApp.Windows_0.0.1.0_anycpu_debug.appx
    // NodeKitApp.Phone_0.0.1.0_x86_debug.appxbundle
    // NodeKitApp.Windows10_0.0.1.0_x64_x86_arm.appxbundle
        ...
        return module.exports.findDevice(deploymentTool, deployTarget).then(function(target) {
            ...
            .then(function() { }, function(error) {
                if (error.message.indexOf('Error code 2148734208 for command') === 0) {
                    ...
                    throw new NodeKitError('No Windows Phone device was detected.');
                } else {
                    throw new NodeKitError('Unexpected error from installation: ' + error.message +
                        ' You may have previously installed the app with an earlier version of nodekit-windows.' +
