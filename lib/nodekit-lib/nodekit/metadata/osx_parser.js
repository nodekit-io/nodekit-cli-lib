...
function osx_parser(project) {
    ...
    try {
        ...
        if (!xcodeproj_dir) throw new NodeKitError('The provided path "' + project + '" is not a NodeKit OS X project.');
        ...
        console.error(e);
        throw new NodeKitError('The provided path "'+project+'" is not a NodeKit OS X project.');
    }
